export interface Card { id: string; name: string; description?: string; category?: string; image?: string; effect?: CardEffect; }
export interface CardEffect { type: 'double_score' | 'extra_draw' | 'peek' | 'steal'; params?: Record<string, number>; }
